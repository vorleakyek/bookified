...
export default function HeroSection() {
  return (
    <main className="wrapper container py-12">
      <section className="rounded-[28px] bg-[var(--bg-secondary)] p-7 sm:p-10 lg:p-12 shadow-[var(--shadow-soft-lg)]">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-center">
          ...
          <div className="space-y-5 lg:space-y-6">
            ...
            <p className="text-base sm:text-lg text-[var(--text-secondary)] max-w-xl">
              ...
              learn, and discuss your favorite reads from one place.
            </p>
            <button className="inline-flex items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[#ffffff] px-6 py-3 text-sm sm:text-base font-semibold text-[var(--color-brand)] shadow-[var(--shadow-soft-sm)] transition hover:bg-[#f8f4e9] hover:text-[var(--color-brand-hover)]">
              + Add new book
            </button>
          </div>
